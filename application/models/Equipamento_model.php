...
class equipamento_model extends CI_Model{
	...
	function get_all_equipamento($limite, $offset){
		...
		$this->db->select('equip.codEquip, marca.desc as marca, modelo.desc as modelo, equip.codPatrimonio, tipo.desc as tipo, equip.dataUltimaFalha, equip.dataUltimaManutencao, equip.desc, equip.rfid, equip.tempoUso');
	...
	function get_all_equipamento_cadastro(){
		$this->db->select('equip.codEquip, marca.desc as marca, modelo.desc as modelo, equip.codPatrimonio, tipo.desc as tipo, equip.dataUltimaFalha, equip.dataUltimaManutencao, equip.desc, equip.rfid, equip.tempoUso');
		$this->db->from ('equipamento equip,marca, modelo, tipo');
		$this->db->where('equip.codMarca = marca.codMarca');
		$this->db->where('equip.codModelo = modelo.codModelo');
