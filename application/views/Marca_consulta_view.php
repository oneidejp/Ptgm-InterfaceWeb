                        ...
                        <table id="myTable" class="table table-striped table-bordered sortable">
                            ...
                            <tbody>
                                ...
                                foreach ($marca as $dados) {
                                    ...
                                    <tr>
                                        <td>
                                            <a href="<?php echo base_url('') ?>index.php/marca/apagar_marca/<?php echo $dados->codMarca; ?>" onClick="return confirm('<?php echo $this->lang->line('msg_confirm_delete') . " " . $this->lang->line('trademark') . " " . $this->lang->line('code') . ": " . $dados->codMarca; ?> ?')">
                                                <img src="<?php echo base_url('includes/imagens/delete.png') ?>"></a>
                                            <a href="<?php echo base_url('') ?>index.php/marca/editar_marca/<?php echo $dados->codMarca; ?>">
                                                <img src="<?php echo base_url('includes/imagens/edit.png') ?>"></a>
                                        </td>
                                        <td><a href="<?php echo base_url('') ?>index.php/marca/editar_marca/<?php echo $dados->codMarca; ?>"><?php echo $dados->codMarca; ?></a></td>
                                        <td><a href="<?php echo base_url('') ?>index.php/marca/editar_marca/<?php echo $dados->codMarca; ?>"><?php echo $dados->desc; ?></a></td>
                                    </tr>
                                <?php }
                                ?>
                            </tbody>
