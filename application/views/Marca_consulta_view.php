...
<head>
	<meta charset="utf-8">
	<title><?php echo $this->lang->line('page_title_consult_trademark'); ?></title>
	...
	<div class="container-fluid">
		<div class="row-fluid">
			<div class="span12" id="centro">
				...
				<ul class="abas">
					<li id="consulta" style="background-color: #A9A9A9;"><a href="<?php echo base_url('index.php/marca') ?>" ><?php echo $this->lang->line('consult'); ?></a></li>
					<li id="cadastro"><a href="<?php echo base_url('index.php/marca?link=cadastro') ?>" ><?php echo $this->lang->line('cadastre'); ?></a></li>
				</ul>
				<div id="aba">
					<div class="row-fluid">
							...
							<table id="myTable" class="table table-striped table-bordered sortable">
								...
								<tbody>
									...
									foreach ($marca as $dados) {
										...
										<tr>
											<td>
												<a href="<? echo base_url('')?>index.php/marca/apagar_marca/<?php echo $dados->codMarca; ?>" onClick="return confirm('<?php echo $this->lang->line('msg_confirm_delete')." ".$this->lang->line('trademark')." ".$this->lang->line('code').": ".$dados->codMarca; ?> ?')">
													<img src="<? echo base_url('includes/imagens/delete.png') ?>"></a>
													<a href="<? echo base_url('')?>index.php/marca/editar_marca/<?php echo $dados->codMarca; ?>">
														<img src="<? echo base_url('includes/imagens/edit.png') ?>"></a>
													</td>
													<td><a href="<? echo base_url('')?>index.php/marca/editar_marca/<?php echo $dados->codMarca; ?>"><?php echo $dados->codMarca; ?></a></td>
													<td><a href="<? echo base_url('')?>index.php/marca/editar_marca/<?php echo $dados->codMarca; ?>"><?php echo $dados->desc; ?></a></td>
												</tr>
												<?php	};
												?>
											</tbody>
