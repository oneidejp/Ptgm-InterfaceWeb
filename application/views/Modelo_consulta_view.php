                        ...
                        <table id="myTable" class="table table-striped table-bordered sortable">
                            ...
                            <tbody>
                                ...
                                foreach ($modelo as $dados) {
                                    ...
                                    <tr>
                                        <td>
                                            <a href="<?php echo base_url('') ?>index.php/modelo/apagar_modelo/<?php echo $dados->codModelo; ?>" onClick="return confirm('<?php echo $this->lang->line('msg_confirm_delete') . " " . $this->lang->line('template') . " " . $this->lang->line('code') . ": " . $dados->codModelo; ?>?')">
                                                <img src="<?php echo base_url('includes/imagens/delete.png') ?>"></a>
                                            <a href="<?php echo base_url('') ?>index.php/modelo/editar_modelo/<?php echo $dados->codModelo; ?>">
                                                <img src="<?php echo base_url('includes/imagens/edit.png') ?>"></a>
                                        </td>
                                        <td><a href="<?php echo base_url('') ?>index.php/modelo/editar_modelo/<?php echo $dados->codModelo; ?>"><?php echo $dados->codModelo; ?></a></td>
                                        <td><a href="<?php echo base_url('') ?>index.php/modelo/editar_modelo/<?php echo $dados->codModelo; ?>"><?php echo $dados->desc; ?></a></td>
                                    </tr>
                                <?php }
                                ?>
                            </tbody>
