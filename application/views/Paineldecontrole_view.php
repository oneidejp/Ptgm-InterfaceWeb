                ...
                foreach ($usosala as $dados) {
                    ...
                    <form class="paineldecontrole">
                        <fieldset>
                            ...
                            <a href="<?php echo base_url('index.php/detalhes/index/' . $dados->codUsoSala) ?>" 
                               style="margin-top: 15px;" target="_blanck" class="btn btn-primary"><?php echo $this->lang->line('details'); ?></a>
        ...
        $.ajax({
            ...
            success: function (dados) {
                for (var l = 0; l < dados.alerta.length; l++) {
                    $("#alerta" + dados.alerta[l].codUsoSala).html("<a href='<?php echo base_url('index.php/alertas/index/" + dados.alerta[l].codUsoSala + "') ?>' class='btn btn-danger' style='margin-top: 15px;' '><?php echo $this->lang->line('alert'); ?></a>");
                }
            }
        });
    }
...
<?php foreach ($alerta as $dados) { ?>
            ...
            $("#alerta" + recebe).html("<a href='<?php echo base_url('index.php/alertas/index/' . $dados->codUsoSala) ?>' class='btn btn-danger' style='margin-top: 15px;''><?php echo $this->lang->line('alert'); ?></a>");
<?php } ?>
    });
</script>
