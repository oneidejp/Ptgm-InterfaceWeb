...
<head>
	<meta charset="utf-8">
	<title><?php echo $this->lang->line('page_title_consult_procedure'); ?></title>
							...
							<table id="myTable" class="table table-striped table-bordered sortable">
								...
								<tbody>
									...
									foreach ($procedimento as $dados) {
										...
										<tr>
											<td>
												<a href="<? echo base_url('')?>index.php/procedimento/apagar_procedimento/<?php echo $dados->codProced; ?>" onClick="return confirm('<?php echo $this->lang->line('msg_confirm_delete')." ".$this->lang->line('procedure')." ".$this->lang->line('code').": ".$dados->codProced; ?>?')">
													<img src="<? echo base_url('includes/imagens/delete.png') ?>"></a>
													<a href="<? echo base_url('')?>index.php/procedimento/editar_procedimento/<?php echo $dados->codProced; ?>">
														<img src="<? echo base_url('includes/imagens/edit.png') ?>"></a>
													</td>
													<td><a href="<? echo base_url('')?>index.php/procedimento/editar_procedimento/<?php echo $dados->codProced; ?>"><?php echo $dados->codProced; ?></a></td>
													<td><a href="<? echo base_url('')?>index.php/procedimento/editar_procedimento/<?php echo $dados->codProced; ?>"><?php echo $dados->desc; ?></a></td>
												</tr>
												<?php		};
												?>
											</tbody>
