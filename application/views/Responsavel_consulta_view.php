                        ...
                        <table id="myTable" class="table table-striped table-bordered sortable">
                            ...
                            <tbody>
                                ...
                                foreach ($responsavel as $dados) {
                                    ...
                                    <tr>
                                        <td>
                                            <a href="<?php echo base_url('') ?>index.php/responsavel/apagar_responsavel/<?php echo $dados->codResp; ?>" onClick="return confirm('<?php echo $this->lang->line('msg_confirm_delete') . " " . $this->lang->line('responsible') . " " . $this->lang->line('code') . ": " . $dados->codResp; ?>?')">
                                                <img src="<?php echo base_url('includes/imagens/delete.png') ?>"></a>
                                            <a href="<?php echo base_url('') ?>index.php/responsavel/editar_responsavel/<?php echo $dados->codResp; ?>">
                                                <img src="<?php echo base_url('includes/imagens/edit.png') ?>"></a>
                                        </td>
                                        <td><a href="<?php echo base_url('') ?>index.php/responsavel/editar_responsavel/<?php echo $dados->codResp; ?>"><?php echo $dados->codResp; ?></a></td>
                                        <td><a href="<?php echo base_url('') ?>index.php/responsavel/editar_responsavel/<?php echo $dados->codResp; ?>"><?php echo $dados->desc; ?></a></td>
                                    </tr>
                                <?php }
                                ?>
                            </tbody>
