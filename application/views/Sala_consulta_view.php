...
<head>
	<meta charset="utf-8">
	<title><?php echo $this->lang->line('page_title_consult_room'); ?></title>
					...
					<div class="row-fluid">
						<div class="span12" id="formcentro">
							<table id="myTable" class="table table-striped table-bordered sortable">
								<caption><h2><?php echo $this->lang->line('table_title_room'); ?></h2></caption>
								<thead>
									<tr>
										<th  class="col1">
								...
								<tbody>
									...
									foreach ($sala as $dados) {
										...
										<tr>
											<td>
												<a href="<? echo base_url('')?>index.php/sala/apagar_sala/<?php echo $dados->codSala; ?>" onClick="return confirm('<?php echo $this->lang->line('msg_confirm_delete')." ".$this->lang->line('room')." ".$this->lang->line('code').": ".$dados->codSala; ?>?')">
													<img src="<? echo base_url('includes/imagens/delete.png') ?>"></a>
													<a href="<? echo base_url('')?>index.php/sala/editar_sala/<?php echo $dados->codSala; ?>">
														<img src="<? echo base_url('includes/imagens/edit.png') ?>"></a>
													</td>
													<td><a href="<? echo base_url('')?>index.php/sala/editar_sala/<?php echo $dados->codSala; ?>"><?php echo $dados->codSala; ?></a></td>
													<td><a href="<? echo base_url('')?>index.php/sala/editar_sala/<?php echo $dados->codSala; ?>"><?php echo $dados->desc; ?></a></td>
												</tr>
												<?php		};
												?>
											</tbody>
