            ...
            <div id="aba1">
                <div class="row-fluid">
                    <div class="col-xs-10 col-xs-offset-1" id="formcentro">
                        <h2><?php echo $this->lang->line('table_title_kind'); ?></h2>
                        <table id="myTable" class="table table-striped table-bordered sortable">
                            ...
                            <tbody>
                                ...
                                foreach ($tipo as $dados) {
                                    ...
                                    <tr>
                                        <td>
                                            <a href="<?php echo base_url('') ?>index.php/tipo/apagar_tipo/<?php echo $dados->codTipo; ?>" onClick="return confirm('<?php echo $this->lang->line('msg_confirm_delete') . " " . $this->lang->line('kind') . " " . $this->lang->line('code') . ": " . $dados->codTipo; ?>?')">
                                                <img src="<?php echo base_url('includes/imagens/delete.png') ?>"></a>
                                            <a href="<?php echo base_url('') ?>index.php/tipo/editar_tipo/<?php echo $dados->codTipo; ?>">
                                                <img src="<?php echo base_url('includes/imagens/edit.png') ?>"></a>
                                        </td>
                                        <td><a href="<?php echo base_url('') ?>index.php/tipo/editar_tipo/<?php echo $dados->codTipo; ?>"><?php echo $dados->codTipo; ?></a></td>
                                        <td><a href="<?php echo base_url('') ?>index.php/tipo/editar_tipo/<?php echo $dados->codTipo; ?>"><?php echo $dados->desc; ?></a></td>
                                    </tr>
                                <?php }
                                ?>
                            </tbody>
