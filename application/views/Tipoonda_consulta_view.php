...
<head>
	<meta charset="utf-8">
	<title><?php echo $this->lang->line('page_title_consult_kind_of_wave'); ?></title>
					...
					<div class="row-fluid">
						<div class="span12" id="formcentro">
							<table id="myTable" class="table table-striped table-bordered sortable">
								<caption><h2><?php echo $this->lang->line('table_title_kind_of_wave'); ?></h2></caption>
								<thead>
									<tr>
										<th  class="col1">
								...
								<tbody>
									...
									foreach ($tipoonda as $dados) {
										...
										<tr>
											<td>
												<a href="<? echo base_url('')?>index.php/tipoonda/apagar_tipoonda/<?php echo $dados->codTipoOnda; ?>" onClick="return confirm('<?php echo $this->lang->line('msg_confirm_delete')." ".$this->lang->line('kinds_of_wave')." ".$this->lang->line('code').": ".$dados->codTipoOnda; ?>?')">
													<img src="<? echo base_url('includes/imagens/delete.png') ?>"></a>
													<a href="<? echo base_url('')?>index.php/tipoonda/editar_tipoonda/<?php echo $dados->codTipoOnda; ?>">
														<img src="<? echo base_url('includes/imagens/edit.png') ?>"></a>
													</td>
													<td><a href="<? echo base_url('')?>index.php/tipoonda/editar_tipoOnda/<?php echo $dados->codTipoOnda; ?>"><?php echo $dados->codTipoOnda; ?></a></td>
													<td><a href="<? echo base_url('')?>index.php/tipoonda/editar_tipoonda/<?php echo $dados->codTipoOnda; ?>"><?php echo $dados->desc; ?></a></td>
												</tr>
												<?php		};
												?>
											</tbody>
