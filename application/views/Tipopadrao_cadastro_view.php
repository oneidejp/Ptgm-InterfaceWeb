                ...
                <div class="row-fluid">
                    ...
                    <div class="col-md-4 col-xs-4" id="formcentro">
                        <?php if ($tipopadrao == 'cadastro') { ?>
                            ...
                            ?>
                            <form class="form-signin" role="form" method="post" action="<?php echo base_url('index.php/tipopadrao/editar_tipopadrao/' . $tipopadrao->codTipoPadrao) ?>">
                                <fieldset>
                                    ...
                                    <button class="btn  btn-primary" type="submit" formaction="<?php echo base_url('index.php/tipopadrao'); ?>"><?php echo $this->lang->line('cancel'); ?></button>
                                </fieldset>
                            </form>	
                            <?php
