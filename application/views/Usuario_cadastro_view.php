...
<head>
	<meta charset="utf-8">
	<title><?php echo $this->lang->line('page_title_cadastre_user'); ?></title>
						...
						<div class="span4" id="formcentro">
							...
							<form class="form-signin" role="form" method="post" action="<?= base_url('index.php/usuario/editar_usuario/'.$usuario->id) ?>">
								<fieldset>
									...
									<h4 class="form-signin-heading"><?php echo $this->lang->line('level').":"; ?></h4>
									<select name="nivel">
										<option value="1" <?php if($usuario->nivel=='1'){echo ' selected';} ?>><?php echo $this->lang->line('administrador'); ?></option>
										<option value="2" <?php if($usuario->nivel=='2'){echo ' selected';} ?>><?php echo $this->lang->line('supervisor'); ?></option>
										<option value="3" <?php if($usuario->nivel=='3'){echo ' selected';} ?>><?php echo $this->lang->line('operator'); ?></option>
										<option value="4" <?php if($usuario->nivel=='4'){echo ' selected';} ?>><?php echo $this->lang->line('viewer'); ?></option>
									</select>
									<br/>
