							...
							<table id="myTable" class="table table-striped table-bordered sortable">
								...
								<thead>
									<tr>
										...
										<th  class="col6">
											<img id="mostrar6" src="<?= base_url('includes/imagens/lupa.png') ?>" />
											<?= $this->lang->line('kind'); ?>
											<img id="filtro6" src="<?= base_url('includes/imagens/filter.png') ?>" /><br/>
											<input type="text" id="txtColuna6" class="6">
											<button id="fechar6" ><?= $this->lang->line('close'); ?></button>
										</th>
										<th  class="col7">
											<img id="mostrar7" src="<?= base_url('includes/imagens/lupa.png') ?>" />
											<?= $this->lang->line('rfid'); ?>
											<img id="filtro7" src="<?= base_url('includes/imagens/filter.png') ?>" /><br/>
											<input type="text" id="txtColuna7" class="7">
											<button id="fechar7" ><?= $this->lang->line('close'); ?></button>
										</th>
										<th  class="col8">
											<img id="mostrar8" src="<?= base_url('includes/imagens/lupa.png') ?>" />
											<?= $this->lang->line('cod_heritage'); ?>
											<img id="filtro8" src="<?= base_url('includes/imagens/filter.png') ?>" /><br/>
											<input type="text" id="txtColuna8" class="8">
											<button id="fechar8" ><?= $this->lang->line('close'); ?></button>
										</th>
										<th  class="col9">
											<img id="mostrar9" src="<?= base_url('includes/imagens/lupa.png') ?>" />
											<?= $this->lang->line('date_last_failure'); ?>
											<img id="filtro9" src="<?= base_url('includes/imagens/filter.png') ?>" /><br/>
											<input type="text" id="txtColuna9" class="9">
											<button id="fechar9" ><?= $this->lang->line('close'); ?></button>
										</th>
										<th  class="col10">
											<img id="mostrar10" src="<?= base_url('includes/imagens/lupa.png') ?>" />
											<?= $this->lang->line('date_last_maintenance'); ?>
											<img id="filtro10" src="<?= base_url('includes/imagens/filter.png') ?>" /><br/>
											<input type="text" id="txtColuna10" class="10">
											<button id="fechar10" ><?= $this->lang->line('close'); ?></button>
										</th>
										<th  class="col11">
											<img id="mostrar11" src="<?= base_url('includes/imagens/lupa.png') ?>" />
											<?= $this->lang->line('usage_time'); ?>
											<img id="filtro11" src="<?= base_url('includes/imagens/filter.png') ?>" /><br/>
								...
								<tbody>
									...
									foreach ($equipamento as $dados) {
										...
										<tr>
											<td>
												<a href="<?= base_url('')?>index.php/equipamento/apagar_equipamento/<?= $dados->codEquip; ?>" onClick="return confirm('<?= $this->lang->line('msg_confirm_delete')." ".$this->lang->line('equipment')." ".$this->lang->line('code').": ".$dados->codEquip; ?> ?')">
													<img src="<?= base_url('includes/imagens/delete.png') ?>"></a>
													<a href="<?= base_url('')?>index.php/equipamento/editar_equipamento/<?= $dados->codEquip; ?>">
														<img src="<?= base_url('includes/imagens/edit.png') ?>"></a>
													</td>
													<td><a href="<?= base_url('')?>index.php/equipamento/editar_equipamento/<?= $dados->codEquip; ?>"><?= $dados->codEquip; ?></a></td>
													<td><a href="<?= base_url('')?>index.php/equipamento/editar_equipamento/<?= $dados->codEquip; ?>"><?= $dados->desc; ?></a></td>
													<td><a href="<?= base_url('')?>index.php/equipamento/editar_equipamento/<?= $dados->codEquip; ?>"><?= $dados->marca; ?></a></td>
													<td><a href="<?= base_url('')?>index.php/equipamento/editar_equipamento/<?= $dados->codEquip; ?>"><?= $dados->modelo; ?></a></td>
													<td><a href="<?= base_url('')?>index.php/equipamento/editar_equipamento/<?= $dados->codEquip; ?>"><?= $dados->tipo; ?></a></td>
													<td><a href="<?= base_url('')?>index.php/equipamento/editar_equipamento/<?= $dados->codEquip; ?>"><?= $dados->rfid; ?></a></td>
													<td><a href="<?= base_url('')?>index.php/equipamento/editar_equipamento/<?= $dados->codEquip; ?>"><?= $dados->codPatrimonio; ?></a></td>
													<td><a href="<?= base_url('')?>index.php/equipamento/editar_equipamento/<?= $dados->codEquip; ?>"><?= date('d/m/Y', strtotime($dados->dataUltimaFalha)); ?></a></td>
													<td><a href="<?= base_url('')?>index.php/equipamento/editar_equipamento/<?= $dados->codEquip; ?>"><?= date('d/m/Y', strtotime($dados->dataUltimaManutencao)); ?></a></td>
													<td><a href="<?= base_url('')?>index.php/equipamento/editar_equipamento/<?= $dados->codEquip; ?>"><?= gmdate("H:i:s", $dados->tempoUso); ?></a></td>
												</tr>
												<?php		};
												?>
											</tbody>
