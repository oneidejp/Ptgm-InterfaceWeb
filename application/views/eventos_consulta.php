...
<head>
	<meta charset="utf-8">
	<title><?php echo $this->lang->line('page_title_consult_events'); ?></title>
							...
							<table id="myTable" class="table table-striped table-bordered sortable">
								...
								<tbody>
									...
									foreach ($eventos as $dados) {
										...
										<tr>
											<td>
												<a href="<? echo base_url('')?>index.php/eventos/apagar_eventos/<?php echo $dados->codEvento; ?>" onClick="return confirm('<?php echo $this->lang->line('msg_confirm_delete')." ".$this->lang->line('kind_of_event')." ".$this->lang->line('code').": ".$dados->codEvento; ?> ?')">
													<img src="<? echo base_url('includes/imagens/delete.png') ?>"></a>
													<a href="<? echo base_url('')?>index.php/eventos/editar_eventos/<?php echo $dados->codEvento; ?>">
														<img src="<? echo base_url('includes/imagens/edit.png') ?>"></a>
													</td>
													<td><a href="<? echo base_url('')?>index.php/eventos/editar_eventos/<?php echo $dados->codEvento; ?>"><?php echo $dados->codEvento; ?></a></td>
													<td><a href="<? echo base_url('')?>index.php/eventos/editar_eventos/<?php echo $dados->codEvento; ?>"><?php echo $dados->desc; ?></a></td>
													<td><a href="<? echo base_url('')?>index.php/eventos/editar_eventos/<?php echo $dados->codEvento; ?>"><?php echo $dados->formaOnda?>  - <?php if($dados->formaOnda==0){echo "Não";}else{echo "Sim";} ?></a></td>
												</tr>
												<?php		};
												?>
											</tbody>
