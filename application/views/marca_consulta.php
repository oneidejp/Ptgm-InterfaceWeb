							...
							<table id="myTable" class="table table-striped table-bordered sortable">
								...
								<tbody>
									...
									foreach ($marca as $dados) {
										...
										<tr>
											<td>
												<a href="<? echo base_url('')?>index.php/marca/apagar_marca/<?= $dados->codMarca; ?>" onClick="return confirm('<?= $this->lang->line('msg_confirm_delete')." ".$this->lang->line('trademark')." ".$this->lang->line('code').": ".$dados->codMarca; ?> ?')">
													<img src="<? echo base_url('includes/imagens/delete.png') ?>"></a>
													<a href="<? echo base_url('')?>index.php/marca/editar_marca/<?= $dados->codMarca; ?>">
														<img src="<? echo base_url('includes/imagens/edit.png') ?>"></a>
													</td>
													<td><a href="<? echo base_url('')?>index.php/marca/editar_marca/<?= $dados->codMarca; ?>"><?= $dados->codMarca; ?></a></td>
													<td><a href="<? echo base_url('')?>index.php/marca/editar_marca/<?= $dados->codMarca; ?>"><?= $dados->desc; ?></a></td>
												</tr>
												<?php	};
												?>
											</tbody>
