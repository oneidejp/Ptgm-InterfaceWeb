							...
							<table id="myTable" class="table table-striped table-bordered sortable">
								...
								<tbody>
									...
									foreach ($procedimento as $dados) {
										...
										<tr>
											<td>
												<a href="<? echo base_url('')?>index.php/procedimento/apagar_procedimento/<?= $dados->codProced; ?>" onClick="return confirm('<?= $this->lang->line('msg_confirm_delete')." ".$this->lang->line('procedure')." ".$this->lang->line('code').": ".$dados->codProced; ?>?')">
													<img src="<? echo base_url('includes/imagens/delete.png') ?>"></a>
													<a href="<? echo base_url('')?>index.php/procedimento/editar_procedimento/<?= $dados->codProced; ?>">
														<img src="<? echo base_url('includes/imagens/edit.png') ?>"></a>
													</td>
													<td><a href="<? echo base_url('')?>index.php/procedimento/editar_procedimento/<?= $dados->codProced; ?>"><?= $dados->codProced; ?></a></td>
													<td><a href="<? echo base_url('')?>index.php/procedimento/editar_procedimento/<?= $dados->codProced; ?>"><?= $dados->desc; ?></a></td>
												</tr>
												<?php		};
												?>
											</tbody>
