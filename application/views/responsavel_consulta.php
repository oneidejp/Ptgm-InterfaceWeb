							...
							<table id="myTable" class="table table-striped table-bordered sortable">
								...
								<tbody>
									...
									foreach ($responsavel as $dados) {
										...
										<tr>
											<td>
												<a href="<?= base_url('')?>index.php/responsavel/apagar_responsavel/<?= $dados->codResp; ?>" onClick="return confirm('<?= $this->lang->line('msg_confirm_delete')." ".$this->lang->line('responsible')." ".$this->lang->line('code').": ".$dados->codResp; ?>?')">
													<img src="<?= base_url('includes/imagens/delete.png') ?>"></a>
													<a href="<?= base_url('')?>index.php/responsavel/editar_responsavel/<?= $dados->codResp; ?>">
														<img src="<?= base_url('includes/imagens/edit.png') ?>"></a>
													</td>
													<td><a href="<?= base_url('')?>index.php/responsavel/editar_responsavel/<?= $dados->codResp; ?>"><?= $dados->codResp; ?></a></td>
													<td><a href="<?= base_url('')?>index.php/responsavel/editar_responsavel/<?= $dados->codResp; ?>"><?= $dados->desc; ?></a></td>
												</tr>
												<?php		};
												?>
											</tbody>
