							...
							<table id="myTable" class="table table-striped table-bordered sortable">
								...
								<tbody>
									...
									foreach ($sala as $dados) {
										...
										<tr>
											<td>
												<a href="<?= base_url('')?>index.php/sala/apagar_sala/<?= $dados->codSala; ?>" onClick="return confirm('<?= $this->lang->line('msg_confirm_delete')." ".$this->lang->line('room')." ".$this->lang->line('code').": ".$dados->codSala; ?>?')">
													<img src="<?= base_url('includes/imagens/delete.png') ?>"></a>
													<a href="<?= base_url('')?>index.php/sala/editar_sala/<?= $dados->codSala; ?>">
														<img src="<?= base_url('includes/imagens/edit.png') ?>"></a>
													</td>
													<td><a href="<?= base_url('')?>index.php/sala/editar_sala/<?= $dados->codSala; ?>"><?= $dados->codSala; ?></a></td>
													<td><a href="<?= base_url('')?>index.php/sala/editar_sala/<?= $dados->codSala; ?>"><?= $dados->desc; ?></a></td>
												</tr>
												<?php		};
												?>
											</tbody>
