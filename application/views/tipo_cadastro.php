...
<head>
	<meta charset="utf-8">
	<title><?php echo $this->lang->line('page_title_cadastre_kind'); ?></title>
						...
						if ($tipo=='cadastro') { ?>
							...
							<form class="form-signin" role="form" method="post" action="<?= base_url('index.php/tipo/editar_tipo/'.$tipo->codTipo) ?>">
								<fieldset>
									...
									<button class="btn btn-lg btn-primary" type="submit" formaction="<?php echo base_url('index.php/tipo'); ?>"><?php echo $this->lang->line('cancel'); ?></button>
								</fieldset>
							</form>	
							<?php
							if($this->session->flashdata('msg'))?>
