...
<head>
	<meta charset="utf-8">
	<title><?= $this->lang->line('page_title_consult_kind'); ?></title>
	...
	<div class="container-fluid">
		<div class="row-fluid">
			<div class="span12" id="centro">
				...
				<ul class="abas">
					<li id="consulta" style="background-color: #A9A9A9;"><a href="<?= base_url('index.php/tipo') ?>" ><?= $this->lang->line('consult'); ?></a></li>
					<li id="cadastro"><a href="<?= base_url('index.php/tipo?link=cadastro') ?>" ><?= $this->lang->line('cadastre'); ?></a></li>
				</ul>
				<div id="aba">
					<div class="row-fluid">
						<div class="span12" id="formcentro">
							<table id="myTable" class="table table-striped table-bordered sortable">
								<caption><h2><?= $this->lang->line('table_title_kind'); ?></h2></caption>
								<thead>
									<tr>
										<th  class="col1">
								...
								<tbody>
									...
									foreach ($tipo as $dados) {
										...
										<tr>
											<td>
												<a href="<? echo base_url('')?>index.php/tipo/apagar_tipo/<?= $dados->codTipo; ?>" onClick="return confirm('<?= $this->lang->line('msg_confirm_delete')." ".$this->lang->line('kind')." ".$this->lang->line('code').": ".$dados->codTipo; ?>?')">
													<img src="<? echo base_url('includes/imagens/delete.png') ?>"></a>
													<a href="<? echo base_url('')?>index.php/tipo/editar_tipo/<?= $dados->codTipo; ?>">
														<img src="<? echo base_url('includes/imagens/edit.png') ?>"></a>
													</td>
													<td><a href="<? echo base_url('')?>index.php/tipo/editar_tipo/<?= $dados->codTipo; ?>"><?= $dados->codTipo; ?></a></td>
													<td><a href="<? echo base_url('')?>index.php/tipo/editar_tipo/<?= $dados->codTipo; ?>"><?= $dados->desc; ?></a></td>
												</tr>
												<?php		};
												?>
											</tbody>
