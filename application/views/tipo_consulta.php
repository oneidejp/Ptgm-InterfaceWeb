							...
							<table id="myTable" class="table table-striped table-bordered sortable">
								...
								<tbody>
									...
									foreach ($tipo as $dados) {
										...
										<tr>
											<td>
												<a href="<?= base_url('')?>index.php/tipo/apagar_tipo/<?= $dados->codTipo; ?>" onClick="return confirm('<?= $this->lang->line('msg_confirm_delete')." ".$this->lang->line('kind')." ".$this->lang->line('code').": ".$dados->codTipo; ?>?')">
													<img src="<?= base_url('includes/imagens/delete.png') ?>"></a>
													<a href="<?= base_url('')?>index.php/tipo/editar_tipo/<?= $dados->codTipo; ?>">
														<img src="<?= base_url('includes/imagens/edit.png') ?>"></a>
													</td>
													<td><a href="<?= base_url('')?>index.php/tipo/editar_tipo/<?= $dados->codTipo; ?>"><?= $dados->codTipo; ?></a></td>
													<td><a href="<?= base_url('')?>index.php/tipo/editar_tipo/<?= $dados->codTipo; ?>"><?= $dados->desc; ?></a></td>
												</tr>
												<?php		};
												?>
											</tbody>
