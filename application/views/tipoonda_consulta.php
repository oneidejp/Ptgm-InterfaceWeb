							...
							<table id="myTable" class="table table-striped table-bordered sortable">
								...
								<tbody>
									...
									foreach ($tipoonda as $dados) {
										...
										<tr>
											<td>
												<a href="<? echo base_url('')?>index.php/tipoonda/apagar_tipoonda/<?= $dados->codTipoOnda; ?>" onClick="return confirm('<?= $this->lang->line('msg_confirm_delete')." ".$this->lang->line('kinds_of_wave')." ".$this->lang->line('code').": ".$dados->codTipoOnda; ?>?')">
													<img src="<? echo base_url('includes/imagens/delete.png') ?>"></a>
													<a href="<? echo base_url('')?>index.php/tipoonda/editar_tipoonda/<?= $dados->codTipoOnda; ?>">
														<img src="<? echo base_url('includes/imagens/edit.png') ?>"></a>
													</td>
													<td><a href="<? echo base_url('')?>index.php/tipoonda/editar_tipoOnda/<?= $dados->codTipoOnda; ?>"><?= $dados->codTipoOnda; ?></a></td>
													<td><a href="<? echo base_url('')?>index.php/tipoonda/editar_tipoonda/<?= $dados->codTipoOnda; ?>"><?= $dados->desc; ?></a></td>
												</tr>
												<?php		};
												?>
											</tbody>
