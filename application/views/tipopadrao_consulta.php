							...
							<table id="myTable" class="table table-striped table-bordered sortable">
								...
								<tbody>
									...
									foreach ($tipopadrao as $dados) {
										...
										<tr>
											<td>
												<a href="<?= base_url('')?>index.php/tipopadrao/apagar_tipopadrao/<?= $dados->codTipoPadrao; ?>" onClick="return confirm('<?= $this->lang->line('msg_confirm_delete')." ".$this->lang->line('kind_of_standard')." ".$this->lang->line('code').": ".$dados->codTipoPadrao; ?>?')">
													<img src="<?= base_url('includes/imagens/delete.png') ?>"></a>
													<a href="<?= base_url('')?>index.php/tipopadrao/editar_tipopadrao/<?= $dados->codTipoPadrao; ?>">
														<img src="<?= base_url('includes/imagens/edit.png') ?>"></a>
													</td>
													<td><a href="<?= base_url('')?>index.php/tipopadrao/editar_tipopadrao/<?= $dados->codTipoPadrao; ?>"><?= $dados->codTipoPadrao; ?></a></td>
													<td><a href="<?= base_url('')?>index.php/tipopadrao/editar_tipopadrao/<?= $dados->codTipoPadrao; ?>"><?= $dados->desc; ?></a></td>
												</tr>
												<?php		};
												?>
											</tbody>
