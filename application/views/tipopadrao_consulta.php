...
<head>
	<meta charset="utf-8">
	<title><?= $this->lang->line('page_title_consult_kind_of_standards'); ?></title>
	...
	<div class="container-fluid">
		<div class="row-fluid">
			<div class="span12" id="centro">
				...
				<ul class="abas">
					<li id="consulta" style="background-color: #A9A9A9;"><a href="<?= base_url('index.php/tipopadrao') ?>" ><?= $this->lang->line('consult'); ?></a></li>
					<li id="cadastro"><a href="<?= base_url('index.php/tipopadrao?link=cadastro') ?>" ><?= $this->lang->line('cadastre'); ?></a></li>
				</ul>
				<div id="aba">
					<div class="row-fluid">
						<div class="span12" id="formcentro">
							<table id="myTable" class="table table-striped table-bordered sortable">
								<caption><h2><?= $this->lang->line('table_title_kind_of_standards'); ?></h2></caption>
								<thead>
									<tr>
										<th  class="col1">
								...
								<tbody>
									...
									foreach ($tipopadrao as $dados) {
										...
										<tr>
											<td>
												<a href="<? echo base_url('')?>index.php/tipopadrao/apagar_tipopadrao/<?= $dados->codTipoPadrao; ?>" onClick="return confirm('<?= $this->lang->line('msg_confirm_delete')." ".$this->lang->line('kind_of_standard')." ".$this->lang->line('code').": ".$dados->codTipoPadrao; ?>?')">
													<img src="<? echo base_url('includes/imagens/delete.png') ?>"></a>
													<a href="<? echo base_url('')?>index.php/tipopadrao/editar_tipopadrao/<?= $dados->codTipoPadrao; ?>">
														<img src="<? echo base_url('includes/imagens/edit.png') ?>"></a>
													</td>
													<td><a href="<? echo base_url('')?>index.php/tipopadrao/editar_tipopadrao/<?= $dados->codTipoPadrao; ?>"><?= $dados->codTipoPadrao; ?></a></td>
													<td><a href="<? echo base_url('')?>index.php/tipopadrao/editar_tipopadrao/<?= $dados->codTipoPadrao; ?>"><?= $dados->desc; ?></a></td>
												</tr>
												<?php		};
												?>
											</tbody>
