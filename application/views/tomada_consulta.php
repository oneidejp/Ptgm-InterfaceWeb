...
<head>
	<meta charset="utf-8">
	<title><?= $this->lang->line('page_title_consult_plug'); ?></title>
	...
	<div class="container-fluid">
		<div class="row-fluid">
			<div class="span12" id="centro">
				...
				<ul class="abas">
					<li id="consulta" style="background-color: #A9A9A9;"><a href="<?= base_url('index.php/tomada') ?>" ><?= $this->lang->line('consult'); ?></a></li>
					<li id="cadastro"><a href="<?= base_url('index.php/tomada?link=cadastro') ?>" ><?= $this->lang->line('cadastre'); ?></a></li>
				</ul>
				<div id="aba">
					<div class="row-fluid">
						<div class="span12" id="formcentro">
							<table id="myTable" class="table table-striped table-bordered sortable">
								<caption><h2><?= $this->lang->line('table_title_plug'); ?></h2></caption>
								<thead>
									<tr>
										<th  class="col1">
										...
										<th  class="col5">
											...
											<?= $this->lang->line('table_of_contents'); ?>
								...
								<tbody>
									...
									foreach ($tomada as $dados) {
										...
										<tr>
											<td>
												<a href="<?= base_url('')?>index.php/tomada/apagar_tomada/<?= $dados->codTomada; ?>" onClick="return confirm('<?= $this->lang->line('msg_confirm_delete')." ".$this->lang->line('plug')." ".$this->lang->line('code').": ".$dados->codTomada; ?>?')">
													<img src="<?= base_url('includes/imagens/delete.png') ?>"></a>
													<a href="<?= base_url('')?>index.php/tomada/editar_tomada/<?= $dados->codTomada; ?>">
														<img src="<?= base_url('includes/imagens/edit.png') ?>"></a>
													</td>
													<td><a href="<?= base_url('')?>index.php/tomada/editar_tomada/<?= $dados->codTomada; ?>"><?= $dados->codTomada; ?></a></td>
													<td><a href="<?= base_url('')?>index.php/tomada/editar_tomada/<?= $dados->codTomada; ?>"><?= $dados->desc; ?></a></td>
													<td><a href="<?= base_url('')?>index.php/tomada/editar_tomada/<?= $dados->codTomada; ?>"><?= $dados->sala; ?></a></td>
													<td><a href="<?= base_url('')?>index.php/tomada/editar_tomada/<?= $dados->codTomada; ?>"><?= $dados->indice; ?></a></td>
													<td><a href="<?= base_url('')?>index.php/tomada/editar_tomada/<?= $dados->codTomada; ?>"><?= $dados->modulo; ?></a></td>
												</tr>
												<?php		};
												?>
											</tbody>
