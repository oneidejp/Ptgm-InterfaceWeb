...
<head>
	<meta charset="utf-8">
	<title><?php echo $this->lang->line('page_title_consult_plug'); ?></title>
							...
							<table id="myTable" class="table table-striped table-bordered sortable">
								...
								<tbody>
									...
									foreach ($tomada as $dados) {
										...
										<tr>
											<td>
												<a href="<? echo base_url('')?>index.php/tomada/apagar_tomada/<?php echo $dados->codTomada; ?>" onClick="return confirm('<?php echo $this->lang->line('msg_confirm_delete')." ".$this->lang->line('plug')." ".$this->lang->line('code').": ".$dados->codTomada; ?>?')">
													<img src="<? echo base_url('includes/imagens/delete.png') ?>"></a>
													<a href="<? echo base_url('')?>index.php/tomada/editar_tomada/<?php echo $dados->codTomada; ?>">
														<img src="<? echo base_url('includes/imagens/edit.png') ?>"></a>
													</td>
													<td><a href="<? echo base_url('')?>index.php/tomada/editar_tomada/<?php echo $dados->codTomada; ?>"><?php echo $dados->codTomada; ?></a></td>
													<td><a href="<? echo base_url('')?>index.php/tomada/editar_tomada/<?php echo $dados->codTomada; ?>"><?php echo $dados->desc; ?></a></td>
													<td><a href="<? echo base_url('')?>index.php/tomada/editar_tomada/<?php echo $dados->codTomada; ?>"><?php echo $dados->sala; ?></a></td>
													<td><a href="<? echo base_url('')?>index.php/tomada/editar_tomada/<?php echo $dados->codTomada; ?>"><?php echo $dados->indice; ?></a></td>
													<td><a href="<? echo base_url('')?>index.php/tomada/editar_tomada/<?php echo $dados->codTomada; ?>"><?php echo $dados->modulo; ?></a></td>
												</tr>
												<?php		};
												?>
											</tbody>
