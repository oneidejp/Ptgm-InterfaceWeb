							...
							<table id="myTable" class="table table-striped table-bordered sortable">
								...
								<tbody>
									...
									foreach ($tomada as $dados) {
										...
										<tr>
											<td>
												<a href="<? echo base_url('')?>index.php/tomada/apagar_tomada/<?= $dados->codTomada; ?>" onClick="return confirm('<?= $this->lang->line('msg_confirm_delete')." ".$this->lang->line('plug')." ".$this->lang->line('code').": ".$dados->codTomada; ?>?')">
													<img src="<? echo base_url('includes/imagens/delete.png') ?>"></a>
													<a href="<? echo base_url('')?>index.php/tomada/editar_tomada/<?= $dados->codTomada; ?>">
														<img src="<? echo base_url('includes/imagens/edit.png') ?>"></a>
													</td>
													<td><a href="<? echo base_url('')?>index.php/tomada/editar_tomada/<?= $dados->codTomada; ?>"><?= $dados->codTomada; ?></a></td>
													<td><a href="<? echo base_url('')?>index.php/tomada/editar_tomada/<?= $dados->codTomada; ?>"><?= $dados->desc; ?></a></td>
													<td><a href="<? echo base_url('')?>index.php/tomada/editar_tomada/<?= $dados->codTomada; ?>"><?= $dados->sala; ?></a></td>
													<td><a href="<? echo base_url('')?>index.php/tomada/editar_tomada/<?= $dados->codTomada; ?>"><?= $dados->indice; ?></a></td>
													<td><a href="<? echo base_url('')?>index.php/tomada/editar_tomada/<?= $dados->codTomada; ?>"><?= $dados->modulo; ?></a></td>
												</tr>
												<?php		};
												?>
											</tbody>
